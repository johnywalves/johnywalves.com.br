...
![Resultado de pesquisa do Google Search com um seta vermelha na quinta posição](/figures/seo_cor_2022-09-28.jpg "Box Shadow | Johny W. Alves 5ª posição")
...
**Explicação rápida de HSL para** <span style="background-color:hsl(325, 84%, 48%);padding:8px 12px;font-size:1.25rem;" class="text-color light">hsl(325, 84%, 48%)</span>

O atributo HSL é a representação na roda das cores ou círculo cromático

![Roda de cores com branco no meio e as bordas com todas as cores](/figures/hue-colors-e0138c.jpg)
...
Para a cor <span style="background-color:hsl(325, 84%, 48%);padding:8px 12px;font-size:1.25rem;" class="text-color light">hsl(325, 84%, 48%)</span> podemos deixar escura reduzindo o brilho ou mais clara aumentando o brilho
...
![Relatório do Google Lighthouse com 100 pontos em performance, acessibilidade, boas práticas e seo](/figures/lighthouse_desktop_e0138c.jpg)
