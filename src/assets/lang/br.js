export default {
    ...
    languagesSubLabel: "Minha capacidade de comunicação, escrita ou oral, em diferentes idiomas",
    languages: [
    ...
    services: [
        ...
        },
        {
            ...
            color: "primary",
            description: "Desenvolvedor de sistemas Web (Frontend e Backend), aplicativos para smartphones (Android) e robôs para automação de processos (RPA)"
        },
        {
            title: "Cientista de Dados",
            color: "primary",
            description: "Prática com mineração, manipulação e visualização de dados, construção e aplicação de modelos aprendizado de máquina"
        }
    ],
    pages: {
        madeWith: "feito com",
    ...
    timelime: [
        ...
        },
        {
            ...
            institution: "Globalcode",
            description: [
                "Formação voltada para desenvolvimeto com a linguagem Java para certificação"
            ],
            type: "education"
        },
        {
