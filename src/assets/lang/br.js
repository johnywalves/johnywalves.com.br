const br = {
  ...
  languages: {
    title: "Idiomas",
    description:
      "Minha capacidade de comunicação, escrita ou oral, em diferentes idiomas",
    list: [
      { name: "Português", proficiency: "Nativo", image: "brazilian.png" },
  ...
  education: {
    ...
    list: [
      ...
      },
      {
        ...
        production: {
          title:
            "Título: ForeSeries - Uma abordagem para predição de valores em séries temporais",
      ...
      },
      {
        ...
        description: [
          "Formação técnica com lógica, introdução para manutenção de hardware e desenvolvimento Web e Desktop",
        ],
      },
    ],
  },
