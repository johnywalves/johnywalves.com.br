export default {
    ...
    languages: {
        title: "Idiomas",
        description: "Minha capacidade de comunicação, escrita ou oral, em diferentes idiomas",
        list: [
    ...
    softSkills: {
        ...
        description: "Algumas coisas que acredito serem meu forte ao lidar com outras pessoas",
        list: ["Amigável", "Atencioso", "Senso de equipe", "Disposição para aprendizado"],
    },
    hardSkills: {
        title: "Conhecimentos",
        description: "Coisas que acredito possuir capacidade de ser produtivo e gosto de trabalhar",
        list: [{
            type: "Linguagens",
            list: [
                { title: "C#" },
    ...
    education: {
        ...
        description: "Minha história em experiências profissionais e formação acadêmica",
        list: [
            {
